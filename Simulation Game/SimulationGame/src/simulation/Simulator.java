...
private static ResidentialBuilding retrieveBuilding (Address a) {
...
private void loadUnits(String filePath)throws IOException {
	...
	while((currentLine=br.readLine())!=null){
		...
		case"GCU":emergencyUnits.add(new GasControlUnit(s[1],world[0][0],Integer.parseInt(s[2])));}		}
...
private void loadDisasters(String filePath) throws IOException{
	...
	while((currentLine=br.readLine())!=null){
		...
		case"FIR": plannedDisasters.add( new Fire(Integer.parseInt(s[0]),retrieveBuilding (world[Integer.parseInt(s[2])][Integer.parseInt(s[3])])));
