...
public class Citizen implements Rescuable,Simulatable{
	...
	public String toString(){
		...
		return "Citizen name:" + this.name + "\n" + "age:" + this.age + "\n" + "ID:" + this.nationalID + "\n" + "Location: (" + this.location.getX() + "," + this.location.getY() + ")" +"\n"+ "Hp leval:"+ this.hp + "\n"+ "Toxicity level:" + this.toxicity + "\n" + "BloodLoss :" + this.bloodLoss + "\n" + "Disaster occuring:" + this.disaster + "CitizenState:" + this.state;
		return "Citizen name:" + this.name + "\n" + "age:" + this.age + "\n" + "ID:" + this.nationalID + "\n" + "Location: (" + this.location.getX() + "," + this.location.getY() + ")"  +"\n"+ "Hp leval:"+ this.hp + "\n"+ "Toxicity level:" + this.toxicity + "\n" + "BloodLoss :" + this.bloodLoss + "\n"  + "CitizenState:" + this.state;
}}
